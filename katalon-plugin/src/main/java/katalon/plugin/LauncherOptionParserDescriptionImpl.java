...
import katalon.plugin.internal.ReportPortalConsoleOption;
import katalon.plugin.internal.TagsConsoleOption;
import katalon.plugin.utils.Constant;
import katalon.plugin.utils.TagsUtils;
